...
var demo0 = new DemoTrial(
	...
	function (event) {allow_continue = true} // this needs to be a function of event
	,
...
var demo2 = new DemoTrial(
	//gridworld
	{
		...
		walls : [],
		tile_size: demo_tile_size,
		goals : [{agent:'agent1', location: [0,0], label: 'Goal', display_label: 'Goal'}],
		agents : [{name : 'agent1'}]
	},
	//initial state
	{
...
var generate_demo6 = function(response_handler) {
	var demo = new DemoTrial(
		//gridworld
		{
			...
			walls : [],
			tile_size: demo_tile_size,
			goals : [{agent:'agent1', location: [4, 4], label: 'Goal', display_label: 'Goal'}],
			agents : [{name : 'agent1'}]
		},
		//initial state
		{
	...
	var demo = new DemoTrial(
		//gridworld
		{
			...
			//walls: [[0, 0, 'right'], [1, 0, 'left'], [0, 1, 'right'], [1, 1, 'left'],//[0,2,'right'],[1,2,'left'],
				//[2, 2, 'down'], [2, 1, 'up']],
			tile_size: demo_tile_size,
			goals: [{agent: 'agent1', location: [4, 0], label: 'Goal', display_label: 'Goal'}],
			agents: [{name: 'agent1'}]
		},
		//initial state
		{
		...
		,
		//initial text, display id, message id
		'Look! The goal has moved!<br> Go to the goal<br>'
			+' <span style="color: #707070">Use the ' + instruction_set_a + ' keys to move.</span>',
		'#task_display',
		'#trial_text'
	);
...
var generate_demo8 = function(response_handler) {
	var demo = new DemoTrial(
		//gridworld
		{
			...
			tile_size: demo_tile_size,
			goals: [
                {agent:'agent1', location: [0,3], label: 'Goal', display_label: 'Goal'},
                {agent:'agent1', location: [3,4], label: 'Goal', display_label: 'Goal'}
            ],
			agents: [{name: 'agent1'}]
		},
		//initial state
		...
		,
		//initial text, display id, message id
		'Sometimes, there will be multiple goals in a trial<br> Go to either goal to continue<br>' +
			'<span style="color: #707070">Use the ' + instruction_set_b + ' keys to move.</span>',
		'#task_display',
		'#trial_text'
	//demo.
...
var endDemo = new DemoTrial(
	//gridworld
	{
		...
		walls : [],
		goals : [
			{agent:'agent1', location: [0,0], label: 'Goal', display_label: 'Goal'},
            {agent:'agent1', location: [0,1], label: 'Goal', display_label: 'Goal'},
			{agent:'agent1', location: [0,2], label: 'Goal', display_label: 'Goal'},
            {agent:'agent1', location: [0,3], label: 'Goal', display_label: 'Goal'},
			{agent:'agent1', location: [1,4], label: 'Goal', display_label: 'Goal'},
            {agent:'agent1', location: [1,0], label: 'Goal', display_label: 'Goal'},
			{agent:'agent1', location: [2,0], label: 'Goal', display_label: 'Goal'},
            {agent:'agent1', location: [3,0], label: 'Goal', display_label: 'Goal'},
			{agent:'agent1', location: [4,0], label: 'Goal', display_label: 'Goal'},
			{agent:'agent1', location: [4,1], label: 'Goal', display_label: 'Goal'},
            {agent:'agent1', location: [4,2], label: 'Goal', display_label: 'Goal'},
			{agent:'agent1', location: [4,3], label: 'Goal', display_label: 'Goal'},
            {agent:'agent1', location: [4,4], label: 'Goal', display_label: 'Goal'},
			{agent:'agent1', location: [0,4], label: 'Goal', display_label: 'Goal'},
            {agent:'agent1', location: [1,4], label: 'Goal', display_label: 'Goal'},
			{agent:'agent1', location: [2,4], label: 'Goal', display_label: 'Goal'},
            {agent:'agent1', location: [3,4], label: 'Goal', display_label: 'Goal'}
		],
		tile_size: demo_tile_size,
		agents : [{name : 'agent1'}]
...
var demo_trials = [demo0, demo1, demo2, demo3, demo5, demo6, demo7, demo8, endDemo];
