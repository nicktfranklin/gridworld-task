...
//var cardinal_order_a = ['right', 'down', 'left', 'up'];
//var cardinal_order_b = ['up', 'left', 'down', 'right'];
//var cardinal_order_c = ['down', 'up', 'right', 'left'];
//var cardinal_order_d = ['left', 'right', 'up', 'down'];
